function [refinedData ] = RemoveWater(conn,refinedData,controlTable, runParams )
...
waterSignal=GetWaterClass(conn,refinedData.experiment_Index, refinedData.colNames, controlTable);
totalLost = 0;
totalPossible=0;
