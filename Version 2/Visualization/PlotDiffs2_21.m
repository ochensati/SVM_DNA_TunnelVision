...
for groupIndex = 1:length(runParams.plot_Analytes)
    ...
    analyte3Name = runParams.plot_Analytes{groupIndex}{3};
    ...
    if false
        ...
        params3=dataTable(indZ,7:end);
        params4=dataTable(indW,7:end);
    end
